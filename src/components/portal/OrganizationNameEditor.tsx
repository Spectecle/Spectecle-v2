      ...
      <div>
        <div className="flex items-center gap-1.5 flex-wrap">
          <input
            ...
            autoFocus
            className="bg-[var(--portal-card)] border border-[var(--portal-border-strong)] text-[var(--portal-text-primary)] px-2 py-1 text-sm outline-none focus:border-[#cb7c46]/50 w-44"
          />
          <input
            type="text"
            value={website}
