    ...
    <section className={cn("bg-white text-[#1e1e1e]", "py-8 sm:py-14 md:py-20 px-0", className)}>
      <style>{`
        ...
        .testimonial-marquee-track {
          animation: testimonial-marquee var(--duration) linear infinite;
        }
        .testimonial-marquee-group:hover .testimonial-marquee-track {
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-4 text-center sm:gap-16">
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          <div className="testimonial-marquee-group flex overflow-hidden p-2 [--gap:1rem] [gap:var(--gap)] flex-row [--duration:70s]">
            <div className="testimonial-marquee-track flex shrink-0 justify-around [gap:var(--gap)] flex-row">
