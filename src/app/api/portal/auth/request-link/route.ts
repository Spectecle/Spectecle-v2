      ...
      html: `
        <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px;background:#fff;">
          ...
          <p style="margin:28px 0;">
            <a href="${link}" style="display:inline-block;background:#cb7c46;color:#1e1e1e;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;font-size:15px;">Sign in</a>
          </p>
