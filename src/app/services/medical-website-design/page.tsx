    ...
    <>
      ...
      <section className="pt-40 pb-14 px-6">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_1fr] gap-14 items-center">
          <div>
            ...
            >
              Medical website design <span className="italic text-[#f87444]">built to earn patient trust.</span>
            </motion.h1>
                ...
                <Reveal key={project.slug} delay={i * 0.1}>
                  <Link href={`/work/${project.slug}`} className="group block border border-[var(--site-border)] p-2">
                    ...
                    <div className="flex items-center justify-between px-4 py-4">
                      <span className="text-sm font-semibold text-[var(--site-text-primary)] group-hover:text-[#f87444] transition-colors">
                        View the {project.title} case study
                      </span>
                      <ArrowUpRight className="w-4 h-4 text-[var(--site-text-muted)] group-hover:text-[#f87444] transition-colors" />
                    </div>
                  </Link>
                </Reveal>
              ))}
      ...
      <section className="py-14 px-6 border-t border-[var(--site-border)]">
        <div className="max-w-3xl mx-auto text-center">
          <Reveal>
            <Quote className="w-8 h-8 text-[#f87444] mx-auto mb-6" strokeWidth={1.5} />
            <blockquote
        ...
        <Reveal>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-5xl md:text-6xl font-light text-[var(--site-text-primary)]" style={{ fontFamily: "var(--font-serif)" }}>
              Give your practice <span className="italic text-[#f87444]">the site it deserves.</span>
            </h2>
