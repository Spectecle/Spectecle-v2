...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "E-commerce & Plant Retail — Online Store Design Michigan", url: `${BASE_URL}/work/indoor-garden` },
        { "@type": "ListItem", position: 2, name: "Drywall & Home Services Contractors — Local SEO Detroit Michigan", url: `${BASE_URL}/work/salazar-drywall-pros` },
        { "@type": "ListItem", position: 3, name: "Glass & Mirror Companies — Website Design Detroit Michigan", url: `${BASE_URL}/work/detroit-glass-mirror` },
        { "@type": "ListItem", position: 4, name: "Sports Performance & Healthcare Clinics — Website SEO Michigan", url: `${BASE_URL}/work/the-stat-clinic` },
        { "@type": "ListItem", position: 5, name: "IT & Technology Companies — AI Automation Michigan", url: `${BASE_URL}/work/thematek` },
        { "@type": "ListItem", position: 6, name: "Beauty Studios & Makeup Artists — Local SEO Michigan", url: `${BASE_URL}/work/glam-by-abeer` },
        { "@type": "ListItem", position: 7, name: "Law Firms & Attorneys — Legal Website SEO Michigan", url: `${BASE_URL}/work/nm-legal-firm` },
      ],
    },
    {
      "@type": "BreadcrumbList",
