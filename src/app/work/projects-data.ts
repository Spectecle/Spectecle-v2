...
export const projects: ProjectData[] = [
  {
    slug: "sunshine-photo-shots",
    title: "Sunshine Photo Shots",
    domain: "sunshinephotoshots.com",
    category: "SEO",
    industry: "Photography",
    location: "Michigan",
    tags: ["Photography Website Design", "Local SEO Michigan", "Google Business Profile"],
    gradient: "from-[#F07A3A] via-[#D25124] to-[#8B2800]",
    cardDesc:
      "Michigan photography studio website redesign and local SEO — targeting 'photographer near me' and 'portrait photographer Michigan' searches. Custom Next.js site tripled booking inquiries within 4 months through Google Business Profile, structured data, and a review generation playbook.",
    cardResult: "+180% Organic Traffic",
    cardResultColor: "text-[#F07A3A]",
    shapes: [
      { size: "w-28 h-28 rounded-full", pos: "top-4 right-4", opacity: "bg-white/10" },
      { size: "w-14 h-14 rounded-full", pos: "top-10 right-28", opacity: "bg-white/5" },
      { size: "w-8 h-8 rounded-full", pos: "top-20 right-16", opacity: "bg-white/8" },
      { size: "w-36 h-1.5 rounded", pos: "bottom-14 left-6", opacity: "bg-white/10" },
      { size: "w-24 h-1.5 rounded", pos: "bottom-8 left-6", opacity: "bg-white/10" },
    ],
    tagline: "A photographer's portfolio that books clients on autopilot",
    metaTitle: "Sunshine Photo Shots — Web Design & Local SEO Case Study | Spectecle",
    metaDescription:
      "How Spectecle built a high-performance portfolio website and local SEO strategy for Sunshine Photo Shots in Michigan, driving +180% organic traffic and tripling booking inquiries.",
    metaKeywords: [
      "photography website design Michigan",
      "photographer website case study",
      "local SEO photographer",
    ...
    heroMetrics: [
      ...
      { value: "3×", label: "Booking Inquiries" },
      { value: "98", label: "PageSpeed Score" },
      { value: "6 wks", label: "Delivery Time" },
    ],
    challenge:
      "Sunshine Photo Shots had been running for years, building an audience on Instagram and through word of mouth — but their outdated Squarespace site wasn't converting visitors, and it was invisible in local search. Every time a potential client in Michigan searched 'photographer near me,' they were finding competitors instead. The studio was leaving money on the table with a digital presence that didn't match the quality of their work.",
    solution:
      "We rebuilt the site from the ground up with Next.js — designing a portfolio-first experience that lets the photography speak immediately, with a clear booking flow layered behind it. Alongside the new site, we launched a local SEO strategy targeting high-intent keyword combinations like 'photography studio Michigan' and 'portrait photographer near me,' backed by Google Business Profile optimization, structured data markup, and a review-generation playbook.",
    features: [
      { icon: "camera", label: "Portfolio Gallery System", desc: "Full-screen, lazy-loaded galleries organized by shoot type, style, and client story" },
      { icon: "search", label: "Local SEO Optimization", desc: "Keyword targeting for 'photographer Michigan' and 15+ geo-specific search variants" },
      { icon: "calendar", label: "Online Booking Integration", desc: "Calendar-based booking with deposit collection and automated client reminders" },
      { icon: "map-pin", label: "Google Business Profile", desc: "Complete GBP setup with photo strategy, service listing, and review acquisition system" },
      { icon: "code", label: "Schema Markup", desc: "LocalBusiness, Photograph, and ImageGallery schema for enhanced SERP visibility" },
      { icon: "smartphone", label: "Mobile-First Design", desc: "60%+ of traffic is mobile — designed mobile-first, tested across 12 device sizes" },
    ],
    deliverables: [
      "Custom Next.js portfolio website",
    ...
    services: ["Web Design & Development", "Local SEO", "Google Business Profile Optimization"],
    results: [
      { value: "+180%", label: "Organic traffic in 4 months" },
      { value: "98/100", label: "Google PageSpeed score" },
      { value: "3×", label: "Increase in booking inquiries" },
      { value: "<1.5s", label: "Average page load time" },
    ],
    year: "2024",
    liveUrl: "https://sunshinephotoshots.com",
    screenshotUrl: "https://api.microlink.io?url=https%3A%2F%2Fsunshinephotoshots.com&screenshot=true&meta=false&embed=screenshot.url&waitUntil=networkidle2",
  },
